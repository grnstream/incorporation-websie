...
function BusinessBanner() {
  return (
    <div className="relative w-[90vw] overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 px-8 py-12 md:px-12 md:py-20 lg:px-16 lg:py-24 mb-10 justify-self-center">
      ...
      <div className="relative z-20 text-center text-white">
        ...
        <p className="text-md md:text-xl lg:text-2xl text-blue-100 mb-10 max-w-2xl mx-auto font-light">
